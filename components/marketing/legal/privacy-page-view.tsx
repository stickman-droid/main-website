        ...
        <div className="mx-auto w-full max-w-4xl px-6 lg:px-12">
          ...
          <div className="mt-16 space-y-12 text-[16px] lg:text-[17px] leading-relaxed text-zinc-600 font-medium max-w-[800px]">
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-[#3D3D3D] tracking-tight">1. Introduction</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-[#3D3D3D] tracking-tight">2. Information We Collect</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-[#3D3D3D] tracking-tight">3. How We Use Your Information</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-[#3D3D3D] tracking-tight">4. Cookies and Tracking Technologies</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-[#3D3D3D] tracking-tight">5. Data Sharing</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-[#3D3D3D] tracking-tight">6. Your Rights</h2>
              <p>
