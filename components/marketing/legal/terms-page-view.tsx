...
export function TermsPageView() {
  return (
    <div className="min-h-screen bg-background text-[#252525]">
      <section data-analytics-section="terms_content" className="w-full py-12 lg:py-24">
        <div className="mx-auto w-full max-w-4xl px-6 lg:px-12">
          ...
          <div className="mt-16 space-y-12 text-[16px] lg:text-[17px] leading-relaxed text-[#252525] font-medium max-w-[800px]">
            <p className="text-[#252525] italic">
              Please read these Terms of Service carefully before using Stickman.Design.
            </p>

            <section className="space-y-4">
              <h2 className="text-xl font-bold text-[#252525] tracking-tight">1. Acceptance of Terms</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-[#252525] tracking-tight">2. Intellectual Property Rights</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-[#252525] tracking-tight">3. User Responsibilities</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-[#252525] tracking-tight">4. Prohibited Activities</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-[#252525] tracking-tight">5. Limitation of Liability</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-[#252525] tracking-tight">6. Governing Law</h2>
              <p>
            ...
            <section className="space-y-4 pt-8 border-t border-zinc-100">
              <h2 className="text-xl font-bold text-[#252525] tracking-tight">Changes to Terms</h2>
              <p>
